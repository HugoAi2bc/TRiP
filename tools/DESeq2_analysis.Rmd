...
#Test include from snakemake `r params$printcode`.
#Test include from snakemake `r params$rmd`.
#Test include from snakemake `r params$refCond`.
#Test include from snakemake `r params$logFC`.
#Test include from snakemake `r params$pval`.
...
#                          "black" ) )
#
#Valeurs_Limite_Y <- ifelse((resDESeq$padj < Var_padj & resDESeq$log2FoldChange > Var_log2FC), Var_padj ,
#               ifelse((resDESeq$padj < Var_padj & resDESeq$log2FoldChange < Var_log2FC), Var_padj ,
#               resDESeq$padj) )
#
#Forme_Pixel_Y <- ifelse((resDESeq$padj < Var_padj & resDESeq$log2FoldChange > Var_log2FC), 17 ,
#                           ifelse((resDESeq$padj < Var_padj & resDESeq$log2FoldChange < Var_log2FC), 17 ,
#                                  20) )
#
#
#
...
colnames(Table_Complete) = col.names = c("genes" ,
                               paste("WT", 1:nb_col_condA, sep = "_"),
                               paste("CO", 1:nb_col_condB, sep = "_"),
                               paste("norm.WT", 1:nb_col_condA, sep = "_"),
                               paste("norm.CO", 1:nb_col_condB, sep = "_"),
                               "WT_Mean", "CO_Mean",
                               colnames(resDESeq))
