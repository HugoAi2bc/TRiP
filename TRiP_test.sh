...
# conda list;
snakemake -s /TRiP/Snakefile_test -j --dag -np |  dot -Tsvg > /data/dag_last-run.svg;
snakemake -s /TRiP/Snakefile_test -j --dag -np --forceall |  dot -Tsvg > /data/dag_all.svg;
snakemake -s /TRiP/Snakefile_test -j;
