...
expData = read.table(pathway, header = T, row.names = 1)
...
write.table(Table_Complete,
            file = paste0("/data/RESULTS/DESeq2/complete-64.txt"),
            quote = F, sep = "\t", row.names = F)


write.table(inducedGenes,
            file = paste0("/data/RESULTS/DESeq2/up-64.txt"),
            quote = F, sep = "\t", row.names = F)

write.table(repressedGenes,
            file = paste0("/data/RESULTS/DESeq2/down-64.txt"),
            quote = F, sep = "\t", row.names = F)
```
\
**OUTPUT FILES** :  
All the output files can be found in the directory “RESULTS/DESeq2/”   
`r paste0("/data/RESULTS/DESeq2/complete-64.txt")`  
`r paste0("/data/RESULTS/DESeq2/up-64.txt")  `  
`r paste0("/data/RESULTS/DESeq2/down-64.txt")  `   
\
...
```{r tests}
#CDS=c(37.4108,37.6248,48.9115,38.538,37.5247)
#CDS_mean=mean(CDS)
#five_prime=c(11.3104,10.5024,5.38341,9.44476,9.62386)
#five_prime_mean=mean(five_prime)
#three_prime=c(1.94673,1.34227,0.769487,1.47058,2.35131)
#three_prime_mean=mean(three_prime)
#
#jpeg(filename = "/home/hugo.arbes//Hugo/GST/TRiP/article/data_to_test/LRRK2/RESULTS_isogenic_transcriptome/CDS_vs_UTR.jpeg")
...
#local = read.table("/home/hugo.arbes/Hugo/GST/TRiP/article/data_to_test/LRRK2/gene_list_local.txt",
#                   header = F,
#                   row.names = 1,
#                   col.names = c("iso_MC.1","iso_MC.2","iso_GS.1","iso_GS.2")
#                   )
