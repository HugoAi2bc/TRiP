...
expData = read.csv("/home/hugo.arbes/Hugo/GST/TRiP/article/data_to_test/LRRK2/article_data/DESeq2/lines_normalized/normalized_counts_by_cell_line_matrix2.csv", header = T, row.names = 1, sep = "\t", stringsAsFactors=FALSE)
expData = expData[,5:8]
